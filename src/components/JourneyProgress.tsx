...
import { MapPin, Flag, Footprints, Map } from "lucide-react";
...
export function JourneyProgress({ destination, distanceCovered, showMap = false }: JourneyProgressProps) {
    ...
    <div className="space-y-4">
      ...
      {showMap && (
        ...
        >
          ...
          <JourneyMap destination={destination} distanceCovered={distanceCovered} />
        </motion.div>
      )}
    </div>
  );
